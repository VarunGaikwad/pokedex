...
function getGenderRatio(
  rate: number
): { male: number; female: number } | "genderless" {
  if (rate === -1) {
    return "genderless";
  }
...
export default async function PokemonDetailPage({
  ...
  const evolutionChain = await getEvolutionChain(
    pokemon.species_details.evolution_chain?.url
  );
  ...
  const category =
    pokemon.species_details.genera?.find((g: any) => g.language.name === "en")
      ?.genus || "Unknown";
  ...
  return (
    <div
      className="container mx-auto p-4 md:p-8 animate-fade-in-up opacity-0"
      style={{ animationFillMode: "forwards", animationDelay: "200ms" }}
    >
      <Link
        href="/"
        className="mb-8 inline-flex items-center gap-2 text-black hover:underline"
      >
              ...
              <div className="flex justify-between">
                ...
                <div className="flex flex-col items-end gap-1">
                  {abilities.map((ability: string) => (
                    <span key={ability} className="capitalize font-medium">
                      {ability.replace("-", " ")}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex justify-between items-center">
                ...
                {genderRatio === "genderless" ? (
                  ...
                  <div className="flex items-center gap-2 font-medium">
                    ...
                    <span
                      className="flex items-center"
                      title={`Female: ${genderRatio.female}%`}
                    >
        ...
        <div className="lg:col-span-2 space-y-8">
          <div>
            <div className="flex items-center gap-4 mb-2">
              ...
              <h1 className="text-5xl font-black tracking-tight capitalize font-headline">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="font-headline">Base Stats</CardTitle>
            </CardHeader>
            <CardContent>
